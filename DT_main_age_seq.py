...
#%%    
def DT_main_age_seq(start, stop,  testGroup,  segmentName):
    print ('\n----------Start-----------\n')
#    (n_estimators, 
#     max_depth,  
#     min_samples_split, 
...
#     segmentName) = parsingInit()
    ...
    destinationFolder='D:/GDrive/DT_Data/DAQ_Auto_Features/Results_Thickness_Aging_AllFeatures'
