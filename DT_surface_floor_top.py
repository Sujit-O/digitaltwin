...
#%%    
def DT_surface_floor_top(start, stop,  testGroup,  segmentName,agingTest):
#start=80
#stop=90
#testGroup=90
...
#agingTest=True
    ...
    if agingTest:
        nameStore='_Aging_Test_allFeatures_surface_floor_top'
    else:
        nameStore='_Normal_Test_allFeatures_surface_floor_top'
        
    if 'Floor' in segmentName:
        name1='Surface_Floor1_Top'
#        name2='Surface_Floor4_Bottom'
        segment_Numbers=[7,13]
