...
destinationFolder='D:/GDrive/DT_Data/DAQ_Auto_Features/Results_Surface_AllFeatures'
...
def featureImportance(clf,feature_names,textDescription):
    ...
    name=destinationFolder+'/Surface_FeatureRanking_'+textDescription+'.pdf' ;
    plt.savefig(name,bbox_inches='tight',dpi=1200)
#    plt.show()    
    
    
#%%    
def DT_main_surf_seq(start, stop,  testGroup,  segmentName):
    print ('\n----------Start-----------\n')
#    (n_estimators, 
#     max_depth,  
#     min_samples_split, 
