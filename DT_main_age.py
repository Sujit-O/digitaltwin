...
destinationFolder='D:/GDrive/DT_Data/DAQ_Auto_Features/Results_Thickness_Aging'
...
#    print ('Shape of Training X: ',np.shape(X_Tr),' ...\n')
    ...
    print ('Results:\n')
    featureImportance(clf_Tr, featureNames,'Start_'+str(start)+'_Stop_'+str(stop)+'_TestG_'+str(testGroup)+'_initialRankings_'+segmentName)
...
#    print ('Mean squared Log Error  :', msle_Test ,'\n')
    ...
    fileNamecsv=destinationFolder+'/Age_FeatureRanking_Start_'+str(start)+'_Stop_'+str(stop)+'_TestG_'+str(testGroup)+'_'+segmentName+'.csv'
...
#    print ('Mean squared Log Error  :', msle_Test ,'\n')
    ...
    f.close();
    featureImportance(clf_reTr, featureNames,'Start_'+str(start)+'_Stop_'+str(stop)+'_TestG_'+str(testGroup)+'_reTrainedRankings_'+segmentName)
