...
def intersectionsInsideSquareSIDE(lineSegmentT, xCoordinates, yCoordinates,zCoordinates):
    ...
    return  insideSquare, startTime, stopTime              
#%%    
def DT_getTimingBasedonSegments_withFigureOutput(tdmsFolderName):
    ...
    for file in tdmsFiles: 
        ...
        for channelName in ['Mic_1']:#channelNames:
            ...
            daqstartTime=channel.property('wf_start_time')
            ...
            np.savetxt(directory+'/timingMetaData.csv', [[startTime.hour,startTime.minute,startTime.second,startTime.microsecond, samplingIncrement]], delimiter=',',header='startHour, startMin, startSecond, startMicroSecond,samplingIncrementinSeconds',comments='')
